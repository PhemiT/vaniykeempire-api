...
const DEFAULTS = {
  ...
  heroBio:
    'A Tech/Music Entrepreneur loved for his unique looks, signature sound, and energetic performances. His music blends creativity across different styles to create songs that connect deeply with people — while his technology background empowers an entire generation to build the future.',
  stats: [
  ...
  closingQuote:
    'Building a platform dedicated to discovering talent, developing creators, and empowering the next generation to succeed in both music and technology.',
};
